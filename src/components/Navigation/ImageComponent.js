		...
		<div className="tw-py-5 tw-pl-5 tw-flex tw-flex-row tw-items-center ">
			...
			{(SUPER_USER1 === user?.email || SUPER_USER2 === user?.email) && (
				<Link
					...
					<div className="tw-w-30 tw-h-30 tw-p-2 tw-text-rose-800 tw-text-xl hover:tw-cursor-pointer tw-bg-neutral-200 tw-rounded-full tw-ease-in tw-duration-300 tw-ml-5">
						<RiAdminFill />
					</div>
