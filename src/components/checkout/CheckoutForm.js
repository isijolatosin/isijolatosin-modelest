...
const CheckoutForm = ({ total, itemCount }) => {
	...
	const [allowproceed, setAllowProceed] = React.useState(true) //CHANGE BACK TO FALSE
		...
		<div>
				...
				<div>
					{succeeded ? (
						<article className="tw-text-center tw-mt-5">
							...
							<h4 className="tw-text-xs tw-text-green-700 tw-mb-4">
								Redirecting...
							</h4>
						</article>
					) : (
			...
			<form
				...
				<CardElement
					...
					className="tw-w-[90%] tw-mx-auto tw-border-[1px] tw-border-b-0 tw-p-3 tw-rounded-t-[4px] "
				/>
				<button
					className="tw-bg-neutral-800 tw-w-[90%] tw-flex tw-mx-auto tw-justify-center tw-py-2 tw-rounded-b-md"
