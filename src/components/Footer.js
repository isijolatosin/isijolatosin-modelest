...
function Footer() {
	return (
		<footer className="tw-flex tw-bg-neutral-800 tw-flex-col tw-py-5 tw-justify-center tw-items-center tw-border-t-[1px] tw-border-neutral-700">
