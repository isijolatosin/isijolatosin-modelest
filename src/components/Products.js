...
function Products({ allProducts }) {
	...
	return (
		<div className="tw-pt-10 tw-relative tw-flex tw-flex-col tw-items-center ">
			...
			{singleProducts && (
				<div className="single tw-absolute tw-z-30 tw-overflow-scroll tw-w-[100%] tw-shadow-lg tw-border-neutral-800 tw-h-[100vh] tw-right-0 tw-left-0 tw-top-[50px] md:tw-top-[-5px] md:tw-pt-5 tw-flex tw-flex-col tw-items-start tw-justify-center tw-bg-white">
