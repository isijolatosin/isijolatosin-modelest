					...
					<div className="tw-bg-neutral-50 tw-text-neutral-700">
						<div className="tw-pb-[100px] tw-pt-[120px] md:tw-pt-[80px] tw-px-5 tw-flex tw-flex-col tw-items-left tw-text-sm tw-w-[100%] md:tw-w-[80%] lg:tw-w-[70%] tw-mx-auto">
							...
							<p className="tw-mb-10 tw-leading-7">
								...
								tutorials to in-depth customer reviews. With so much information
								available, it can sometimes be overwhelming in finding the exact
								information you need. In this article, we wanted to provide our
								customers hair care tips for Virgin, Indian and Vietnamese hair
								straight from the source from the time its delivered to the time
								you take it to your trusted cosmetologist.
								<br />
								<br />
								Initially when receiving your Virgin, Indian or Vietnamese Hair
								Extensions you’ll want to inspect your package. This can be done
								by removing each bundle from its individual wrapping. Check to
							...
							<div className="tw-mb-10">
								...
								<p className="tw-leading-7">
									...
									been proven an effective method. The term co-wash means to
									wash hair with only conditioner. This process assist in
									restoring the hair of its moisture and refreshing it back to
									its natural state. In order to co-wash your bundles, we
									recommend using lukewarm water and a conditioner free of
									parabens and sulfate. Once thoroughly co-washed, hang bundles
									to air-dry. Keep in mind that co-washing will need to be
									repeated after your bundles are installed on a weekly basis.
								</p>
							</div>
							<div className="tw-mb-5">
								...
								<p className="tw-leading-7">
									...
									desired look. Virgin, Indian or Vietnamese Hair Extensions
									have an added benefit of not needing a lot of product to
									thrive. Use the mantra “less is more” when considering adding
									products such as serums, oils, mousse, etc; These products can
									weigh down the hair and appear greasy over time. Shampooing
									with a sulfate-free product is even suggested on a bi-weekly
									basis as it can strip the hair of its natural oils leading to
									tangling or shedding as a result of dry strands.
									<br />
									<br />
									Now that you have the basic hair-care tips for Virgin, Indian
									and Vietnamese hair under your belt, you’ll find that your
									overall experience can be hassle-free with just a little
									maintenance.
								</p>
							</div>
						</div>
